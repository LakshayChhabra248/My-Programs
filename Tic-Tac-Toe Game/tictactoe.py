...
class TicTacToe:
    def __init__(self, master):
        ...
        self.menu_buttons_frame = tk.Frame(master)
        self.menu_buttons_frame.grid(row=0, column=0, columnspan=3)

        self.game_board_frame = tk.Frame(master)
        ...
        play_computer_button.grid(row=0, column=1)
    ...
    def start_game(self, mode):
        ...
        self.game_board_frame.grid(row=0, column=0)
        self.create_board()
    ...
    def create_board(self):
        for i in range(9):
            button = tk.Button(self.game_board_frame, text="", font=("Arial", 60), width=3, height=1,
